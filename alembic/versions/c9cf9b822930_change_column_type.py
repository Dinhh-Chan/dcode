...
Revision ID: c9cf9b822930
Revises: 
Create Date: 2025-01-17 14:46:13.357024
...
def upgrade() -> None:
    ...
    sa.Column('do_kho', sa.Enum('Easy', 'Medium', 'Hard', name='difficultyenum'), nullable=True),
